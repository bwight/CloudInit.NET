...
// LSA Functions - Privileges and Impersonation - CodeProject®
// http://www.codeproject.com/Articles/4863/LSA-Functions-Privileges-and-Impersonation
// LSAHelper class taken from the following code
namespace CloudInit
{
    public class LSAHelper
    {
        ...
        public static long AddPrivileges(String accountName, String privilegeName)
        {
